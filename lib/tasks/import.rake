...
["Users Management","Roles Management", "Sites Management", "Videos Management", "Images Management","Content_Library Management", "Add_Forms Management", "Texts Management"].each do |sub_per|
