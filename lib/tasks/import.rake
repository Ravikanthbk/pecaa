...
["Users Management","Roles Management", "Uploads Mangement", "Sites Management", "Videos Management", "Images Management","Content_Library Management", "Add_Forms Management", "Site_Pages"].each do |sub_per|
