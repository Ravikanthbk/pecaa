...
["Users Management","Roles Management", "Uploads Mangement", "Sites Management", "Videos Management", "Images Management","Content_Library Management", "Add_Forms Management"].each do |sub_per|
